...
def main(**kwargs):
    ...
    parser.add_argument('--loss', type=str,default='quantile')
...
# ================================ Hyper Parameters ================================= #
    ...
    model_args['seq_length']    = model_args['seq_length']
    ...
    optim_args['output_seq_len']= optim_args['output_seq_len']
    optim_args['batch_size']    = config['model_args']['batch_size']
# ============================= Model and Trainer ============================= #
    # log
